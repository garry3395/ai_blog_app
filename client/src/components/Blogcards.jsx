...
const Blogcards = ({blog}) => {
  ...
  return (
    <div onClick={()=>navigate(`/blog/${_id}`)} className='w-full rounded-lg overflow-hidden shadow hover:scale-102 hover:shadow-primary/25 duration-300 cursor-pointer'>
      ...
      <div className='p-5'>
        <h5 className='mb-2 font-medium text-gray-900 'dangerouslySetInnerHTML={{"__html":title}}>
      
        
      </h5>
     <p className="mb-3 text-xs text-gray-600" dangerouslySetInnerHTML={{ __html: truncate(description, 80) }} ></p>
