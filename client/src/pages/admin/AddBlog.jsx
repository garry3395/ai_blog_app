  ...
  const [image,setImage]=useState(false)
   ...
   const [subTitle,setSubTitle]=useState(" ")
    ...
    const generateContent= async(e)=>{
       if(!title) return toast.error('Please eter a title')
  ...
  return (
    ...
    <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
      ...
      <p className='mt-4'>Blog Title</p>
        <input type="text" className="w-full max-w-lg mt-2 p-2 border border-gray-300 outlinr-none rounded " placeholder='Type here' required onChange={(e)=>setTitle(e.target.value)} value={title}/>
